...
return [
    ...
    /*
     * Here you can specify the database connection for Mailcoach's models
     * Leave empty to use the app default's env('DB_CONNECTION')
     */
    'database_connection' => '',
        ...
        'options' => [
            ...
            'fonts' => [
                ...
                'customFonts' => [
                    ...
                    ['label' => "Lobster Two", 'value' => "'Lobster Two',cursive", 'url' => "https://fonts.googleapis.com/css?family=Lobster+Two:400,700"],
                    ...
                    ['label' => "Crimson Text", 'value' => "'Crimson Text',serif", 'url' => "https://fonts.googleapis.com/css?family=Crimson+Text:400,700"],
                    ...
                    ['label' => "Cabin", 'value' => "'Cabin',sans-serif", 'url' => "https://fonts.googleapis.com/css?family=Cabin:400,700"],
                    ['label' => "Pacifico", 'value' => "'Pacifico',cursive", 'url' => "https://fonts.googleapis.com/css?family=Pacifico"],
                    ['label' => 'DM Sans', 'value' => "'DM Sans', sans-serif", 'url' => "https://fonts.googleapis.com/css2?family=DM+Sans"],
                ],
            ],
        ],
    ],
